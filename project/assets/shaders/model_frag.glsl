...
void main()
{
    ...
    vec3 diffuseDirectional = light.diffuse * diffDirectional * texture(material.diffuse, TexCoords).rgb;
    ...
    for(int i = 0; i < 3; i++)
    {
        ...
        vec3 diffuseSpotlight = spotlight[i].diffuse * diffSpotlight * spotlightEffect * texture(material.diffuse, TexCoords).rgb;
